...
class MobileNetV3(keras.models.Model):
    def __init__(
            self,
        ...
        self.bneck = keras.Sequential(name="Bneck")
...
class MobileNetV3Extractor(keras.models.Model):
# class MobileNetV3Extractor(keras.layers.Layer):
    def __init__(
            self,
            num_classes: int=1001,
            width_multiplier: float=1.0,
